...
function testSearchParking() {
  const result = searchNearbyParking(25.047924, 121.517081);
  Logger.log(result);
}
...
function testSearchOnStreetParking() {
  const result = searchOnStreetParkingByAddress('臺北市中正區北平西路3號');
  Logger.log(result);
}
...
function testGeocode() {
  const result = geocodeAddress('臺北市中正區北平西路3號');
  Logger.log(result);
}