...
function doGet(e) {
  ...
  if (params.test === 'parking') {
    var lat = parseFloat(params.lat) || 25.047924;
    var lon = parseFloat(params.lon) || 121.517081;
...
function geocodeAddress(address) {
  // 檢查是否為座標格式：25.0479,121.5171 或 25.0479, 121.5171 或 (25.0479, 121.5171)
...
function testSearchParking() {
  var result = searchNearbyParking(25.047924, 121.517081);
  Logger.log(result);
}

function testSearchOnStreetParking() {
  var result = searchOnStreetParkingByAddress('臺北市中正區北平西路3號');
  Logger.log(result);
}

function testSearchOnStreetByCoordinate() {
  var result = searchOnStreetParkingByCoordinate(25.047924, 121.517081);
  Logger.log(result);
}

function testCoordinateInput() {
  // 測試各種座標格式
  var result1 = searchOnStreetParkingByAddress('25.0479,121.5171');
  Logger.log('格式1: ' + result1);
  
  var result2 = searchOnStreetParkingByAddress('25.0479, 121.5171');
  Logger.log('格式2: ' + result2);
  
  var result3 = searchOnStreetParkingByAddress('(25.0479, 121.5171)');
